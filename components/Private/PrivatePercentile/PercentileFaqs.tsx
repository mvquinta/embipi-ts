...
const faqs = [
    ...
    {
        question:
            'Should I be worried if my child percentile values are too low? Or to high?',
        answer: "I don't know, but the flag is a big plus. Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas cupiditate laboriosam fugiat.",
    },
    // More questions...
]
            ...
            <div className='max-w-7xl mx-auto py-6 px-4 sm:py-8 sm:px-6 lg:px-8 '>
                <div className='w-full '>
                    ...
                    <p className='ml-2 mt-1 text-sm text-gray-500'>
                        Important and remember! Information and data shown in
                        embipi is only a rough guide. Everything that concerns
                        you and your family should be consulted with a
