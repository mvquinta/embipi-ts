    ...
    return (
        <>
            <Head>
                <title>embipi</title>
                <meta
                    name='embipi onboarding'
                    content='Page with oboarding form'
                />
                                ...
                                <div className='flex flex-col sm:flex-row justify-start gap-4 mb-6'>
                                    <div>
                                        ...
                                        <input
                                            ...
                                            {...register('userName', {
                                                required:
                                                    'You must insert your userNamename',
                                                minLength: {
                                                    value: 2,
                                                    message:
                                                        'Name is to short.',
                                                ...
                                                maxLength: {
                                                    value: 16,
                                                    message:
                                                        'Name must be under 16 characters',
                                                },
                                                pattern: {
                                                    value: /^[A-Za-z ]+$/i,
                                                    message:
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            {...register('lastName', {
                                                required:
                                                    'You must insert your last name',
                                                minLength: {
                                                    value: 2,
                                                    message:
                                                        'Name is to short.',
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        {...register('userBabyName', {
                                            required:
                                                'You must insert your baby name',
                                            minLength: {
                                                value: 2,
                                            ...
                                            pattern: {
                                                value: /^[A-Za-z ]+$/i,
                                                message:
                                                    'Name can only have alphabtet characters',
                                            },
                                        })}
                                    />
                                    {errors.userBabyName && (
                                    ...
                                    <div className='mt-1 relative rounded-md shadow-sm'>
                                        <input
                                            ...
                                            {...register('userBabyHeight', {
                                                required:
                                                    'Baby Height is required',
                                                maxLength: {
                                                    value: 3,
                                                    message:
                                                        'Value must be max 3 characters',
                                                },
                                                minLength: {
                                                    value: 2,
                                                    message:
                                                        'Value must be min 3 characters',
                                                },
                                            })}
                                        />
                                        ...
                                        <input
                                            ...
                                            {...register('userBabyWeight', {
                                                ...
                                                maxLength: {
                                                    value: 2,
                                                    message:
                                                        'Value must be max 2 characters',
                                                },
                                                minLength: {
                                                    value: 1,
                                                    message:
                                                        'Value must be min 1 characters',
                                                },
                                            })}
                                        />
