    ...
    if (req.method === 'POST') {
        ...
        await prisma.children.create({
            data: {
                ...
                userBabyHeight: parseInt(req.body.data.userBabyHeight),
                userBabyWeight: parseInt(req.body.data.userBabyWeight),
                userBabyHead: parseInt(req.body.data.userBabyHead),
